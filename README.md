...
For this project, you will build a light application that reads data and integrates with an API. The topic is up to you, so pick a project that speaks to your interests.
